...
curl -L https://github.com/dhall-lang/dhall-haskell/releases/download/1.42.2/dhall-yaml-1.7.12-x86_64-linux.tar.bz2 | tar xj --strip-components=1 -C /usr/local/bin